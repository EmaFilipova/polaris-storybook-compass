    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-200/80 py-12">
        <div className="container max-w-7xl">
          <h1 className="font-display text-4xl font-semibold text-gray-900 mb-2">CUE 5 Design System</h1>
          <p className="text-gray-500 text-lg">A comprehensive collection of reusable components</p>
        </div>
      </header>
